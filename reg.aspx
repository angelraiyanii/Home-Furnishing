<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="reg.aspx.cs" Inherits="Home__Furnishing.reg" %>
     ...
     <!-- Start Hero Section 
      ...
      <div class="container">
        ...
        <div class="block">
          ...
          <b><p style="color:darkslategrey;font-family:'Times New Roman';font-size:50px;text-align:center;">Registration Form</p></b>
    <br /><br />
              ...
              <form>
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                        <asp:Label ID="Label1" class="text-black" runat="server" Text="First Name "></asp:Label>
                        <asp:TextBox ID="txtfnm" type="text" class="form-control" runat="server"></asp:TextBox>
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      <asp:Label ID="Label2" class="text-black" runat="server" Text="Last Name "></asp:Label>
                        <asp:TextBox ID="txtlnm" type="text" class="form-control" runat="server"></asp:TextBox>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <br />
                   <div class="form-group">
                      <asp:Label ID="Label5" class="text-black" runat="server" Text="Confirm Password "></asp:Label>
                        <asp:TextBox ID="txtcpass" type="password" class="form-control" runat="server"></asp:TextBox>                   
                </div>
                  <br />
<br />
                   <div style="margin-left:250px;" aria-live="polite">Already have an account? <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/login.aspx">Login</asp:HyperLink></div>
                  <br />
                        
                <div style="text-align:center;"><asp:Button ID="Button1"  runat="server" Text="Submit" class="btn btn-primary-hover-outline" OnClick="Button1_Click" /></div>  
                    ...
                    <div class="row pt-4">
                        <div class="col-lg-6">
                            <p class="mb-2 text-center text-lg-start">
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love by <a href="https://untree.co">Untree.co</a> Distributed By <a hreff="https://themewagon.com">ThemeWagon</a>  <!-- License information: https://untree.co/license/ -->
                          <!--  </p>
                        </div>
